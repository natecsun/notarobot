-- 1. Create saved_results table if it doesn't exist
...
-- 3. Drop existing policies to avoid conflicts before recreating
drop policy if exists "Users can manage own saved results" on saved_results;
drop policy if exists "Public can view shared results" on saved_results;
